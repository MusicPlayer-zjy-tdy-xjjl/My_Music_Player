...
{
    QString info("歌曲名：%1\n艺术家：%2\n时长：%3\n唱片集：%4\n最近播放时间：%5\n比特率：%6\n文件路径：%7");
    info=info.arg(title,author,formatTime(duration),albumTitle,recent_playedtime,QString::number(audioBitRate)+"bps",url.toString());
    QMessageBox::about(Q_NULLPTR,"歌曲信息",info);//打开帮助窗口显示文字info
}
